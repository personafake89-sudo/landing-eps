...
export default function PagoWEBClient() {
            ...
            {paso === 'pagar' && cliente && (
              <form onSubmit={pagar} className="flex flex-col gap-4">
                ...
                <div className="flex items-center justify-center gap-2 flex-wrap py-1">
                  {/* eslint-disable-next-line @next/next/no-img-element */}
                  <img loading="lazy" src="https://static-content.vnforapps.com/v2/img/pci.png" alt="PCI" className="h-5 object-contain" />
                  {/* eslint-disable-next-line @next/next/no-img-element */}
                  <img loading="lazy" src="https://static-content.vnforapps.com/v2/img/bottom/visa.png" alt="Visa" className="h-5 object-contain" />
                  {/* eslint-disable-next-line @next/next/no-img-element */}
                  <img loading="lazy" src="https://static-content.vnforapps.com/v2/img/bottom/mc.png" alt="MC" className="h-5 object-contain" />
                </div>
